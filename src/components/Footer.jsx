...
const Footer = ({theme}) => {
    return (
        <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
            ...
            {/* {footer bottom} */}
            <div className='pb-6 text-sm text-gray-500 flex justify-content-center sm:justify-between gap-4 flex-wrap'>
                <p>Copyright 2025 agency.ai © GreatStack - All Rights Reserved</p>
